<div class="left-sidebar " style="background-color: #073B4C" >
        ...
        <div class="sidebar-nav">
            <ul class="side-nav color-white">
                ...
                <li class="has-children">
                    ...
                    <ul class="child-nav">
                        <li><a href="add-department.php"><i class="fa fa-bars"></i> <span>Create Department</span></a></li>
                        <li><a href="manage-department.php"><i class="fa fa fa-server"></i> <span>Manage Department</span></a></li>
                ...
                <li class="has-children">
                    ...
                    <ul class="child-nav">
                        <li><a href="add-course.php"><i class="fa fa-bars"></i> <span>Create Course</span></a></li>
                        <li><a href="manage-course.php"><i class="fa fa fa-server"></i> <span>Manage Course</span></a></li>
                ...
                <li class="has-children">
                    ...
                    <ul class="child-nav">
                        <li><a href="create-module.php"><i class="fa fa-bars"></i> <span>Create Module</span></a></li>
                        <li><a href="manage-module.php"><i class="fa fa fa-server"></i> <span>Manage Module</span></a></li>
            ...
            <li class="has-children">
                    ...
                    <ul class="child-nav">
                        ...
                        <li><a href="manage-exam.php"><i class="fa fa fa-server"></i> <span>Manage Exam</span></a></li>
