...
$sql1 = "SELECT index_no FROM student";
$result1 = mysqli_query($conn, $sql1);
$totalstudents = mysqli_num_rows($result1);

$sql2 = "SELECT id FROM module";
$result2 = mysqli_query($conn, $sql2);
$totalsubjects = mysqli_num_rows($result2);

$sql3 = "SELECT id FROM course";
$result3 = mysqli_query($conn, $sql3);
$totalcourses = mysqli_num_rows($result3);

$sql4 = "SELECT DISTINCT nic FROM results";
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <a class="dashboard-stat" href="manage-students.php" style="background-color: #E78C6B;">
                                        ...
                                        <span class="name">Reg Students</span>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="margin-top:1%;">
                                    <a class="dashboard-stat" href="manage-classes.php" style="background-color: #06D6A0;">
                                        <span class="number counter"><?php echo htmlentities($totalcourses); ?></span>
